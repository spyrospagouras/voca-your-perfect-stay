import { DollarSign, CalendarCheck, Shield } from "lucide-react";
...
const StepIntro3 = ({ onNext, onBack }: Props) => {
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <OnboardingFooter onBack={onBack} onNext={onNext} nextLabel="Συνέχεια" progress={97} />
    </div>
  );
};

export default StepIntro3;
